...
- [llama.cpp ROCm Build Guide](guides/llama-cpp-rocm-guide.md)
- [vLLM + Qwen2.5 + Open WebUI Setup](guides/vllm-qwen-setup-guide.md)

## Scripts

- [start_model.sh](scripts/start_model.sh) — One-command model startup
- [build_llama.sh](scripts/build_llama.sh) — llama.cpp ROCm build
...
👉 [HuggingFace: rakisis-core/Gemma-4-26B-A4B-Q4K_M-GGUF](https://huggingface.co/rakisis-core/Gemma-4-26B-A4B-Q4K_M-GGUF)
...
*XinXin-Kang / Xinkang Labs 🌐 [xinkanglabs.com.au](https://xinkanglabs.com.au)*
